...
const field = "mt-2 h-[46px] w-full rounded-[5px] border border-[#dfdfdf] bg-white px-4 text-[14px] text-ink focus:outline-2 focus:outline-ocean";
  ...
  return (
    <form
      onSubmit={(e) => {
        ...
        const text = [
          `Hola ${site.name}, soy ${data.get("name") || "un cliente"}.`,
    ...
    >
      ...
      <button className="mt-1 flex h-11 items-center gap-1.5 rounded-[5px] bg-ocean px-5 text-[14px] font-bold text-white hover:bg-ocean-dark">
