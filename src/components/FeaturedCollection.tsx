  ...
  return (
    <section className="container-page">
      ...
      <div className="mt-[30px] grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-5">
        <div className="col-span-2 flex flex-col overflow-hidden rounded-[5px] bg-cielo text-white md:col-span-1">
          ...
          <div className="flex flex-1 flex-col p-5">
            ...
            <Link href={feature.href} className="mt-auto grid h-11 place-items-center rounded-[5px] bg-cielo-dark text-[14px] font-bold transition-colors hover:bg-ocean">
              {feature.cta}
            </Link>
          </div>
        </div>
